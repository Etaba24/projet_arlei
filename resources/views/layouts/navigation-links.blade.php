    ...
    <div>
        ...
        <div class="mt-2 space-y-1">
            <a href="{{ route('dashboard') }}"
               ...
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('dashboard') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                ...
                <a href="{{ route('suivi-production.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('suivi-production.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('ordre-productions.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('ordre-productions.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                ...
                <a href="{{ route('matieres-premieres.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('matieres-premieres.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('produits-semi-finis.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('produits-semi-finis.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('produits-finis.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('produits-finis.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('fournisseurs.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('fournisseurs.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('clients.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('clients.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                ...
                <a href="{{ route('logistique.mp') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('logistique.mp*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('logistique.pf') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('logistique.pf*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                ...
                <a href="{{ route('machines.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('machines.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('transformations.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('transformations.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('conditionnements.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('conditionnements.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                    </svg>
        ...
        <div>
            ...
            <div class="mt-2 space-y-1">
                ...
                <a href="{{ route('equipes.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('equipes.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('employes.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('employes.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('users.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('users.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('roles.index') }}"
                   ...
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->routeIs('roles.*') ? 'text-emerald-600 font-bold hover:bg-emerald-50 sidebar-active-link' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
