        ...
        <x-slot name="header">
            <div class="flex flex-col md:flex-row md:items-center w-full gap-4">
                ...
                <div class="ml-auto flex gap-2 w-full md:w-auto mt-3 md:mt-0">
                    ...
                    <label for="modal-toggle" class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-xl shadow-sm shadow-emerald-600/20 transition-all cursor-pointer group">
