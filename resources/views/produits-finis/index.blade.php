    ...
    <div class="space-y-6">
        ...
        <x-slot name="header">
            <div class="flex flex-col md:flex-row md:items-center w-full gap-4">
                ...
                <div class="ml-auto flex gap-2 w-full md:w-auto mt-3 md:mt-0">
                    ...
                    <label for="modal-create-toggle" class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-xl shadow-sm shadow-emerald-600/20 transition-all cursor-pointer group">
                        ...
                        @forelse ($produits as $produit)
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <form action="{{ route('produits-finis.destroy', $produit) }}" method="POST" class="inline" onsubmit="confirmDelete(event, this)">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <div class="fixed inset-0 z-[60] hidden peer-checked:flex items-center justify-center p-4 text-left font-normal">
                                        ...
                                        <div class="relative bg-white w-full max-w-lg rounded-3xl shadow-2xl border border-slate-100 overflow-hidden animate-modal-pop">
                                            <div class="p-8">
                                                ...
                                                <form action="{{ route('produits-finis.update', $produit) }}" method="POST" class="space-y-6">
                                                    @csrf 
                                                    @method('PUT')
                                                    ...
                                                    <div class="space-y-4">
                                                        ...
                                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                            ...
                                                            <div>
                                                                <label for="qte_en_stock-{{ $produit->code }}" class="block text-sm font-bold text-slate-700 mb-2 text-left">Stock Physique <span class="text-xs font-normal text-slate-400">(Géré par le système)</span></label>
